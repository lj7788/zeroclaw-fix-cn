...
本分支（zeroclaw-fix-cn）包含以下增强功能：

1. **全面汉化**：

   - 工具描述汉化：将所有工具的`fn description(&self)`方法返回值汉化为中文
   - 集成描述汉化：将集成条目（IntegrationEntry）的description字段汉化为中文
   - 前端界面汉化：将前端页面中的英文文本汉化为中文，包括状态标签等
2. **Web项目抽取**：

   - 将web项目分离为独立目录结构（zeroclaw+web目录方式）
   - 修改web_dir判断方式，优先使用外部web/dist目录，不存在则使用内嵌文件
3. **功能增强**：

   - 在Memory.tsx页面增加批量删除功能
   - 修复特定内存条目无法删除的问题
   - **TTS 工具调用解析增强**：修复工具调用标签解析逻辑，支持多种工具调用格式
     - 支持未关闭的工具调用标签（如 `
4. **Gateway效果图**：

   <a target="_blank" rel="noopener noreferrer" href="https://private-user-images.githubusercontent.com/7535786/555845312-9c7df5e9-c4ae-41c6-bbe4-cb01124f7b9e.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..v_lhIXGwlP58Z5YXUuOti1OKaCKpsOnqlTJb7l-ghYA"><img width="2000" height="1070" alt="zeroclaw1" src="https://private-user-images.githubusercontent.com/7535786/555845312-9c7df5e9-c4ae-41c6-bbe4-cb01124f7b9e.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..v_lhIXGwlP58Z5YXUuOti1OKaCKpsOnqlTJb7l-ghYA" content-type-secured-asset="image/png" style="max-width: 100%; height: auto; max-height: 1070px;"></a><br>
   <a target="_blank" rel="noopener noreferrer" href="https://private-user-images.githubusercontent.com/7535786/555845330-7c6d4ea8-bc5b-4fca-96ac-777c0a56d79f.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6WFQwoSZzDErefiuIV0tU7JaCwazObzx64LA1rIJpOs"><img width="2000" height="1069" alt="zeroclaw02" src="https://private-user-images.githubusercontent.com/7535786/555845330-7c6d4ea8-bc5b-4fca-96ac-777c0a56d79f.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6WFQwoSZzDErefiuIV0tU7JaCwazObzx64LA1rIJpOs" content-type-secured-asset="image/png" style="max-width: 100%; height: auto; max-height: 1069px;"></a><br>
   <a target="_blank" rel="noopener noreferrer" href="https://private-user-images.githubusercontent.com/7535786/555845353-79c605f0-ee39-42dc-a203-b40368dbbce7.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..CC8wD0oYwPZzTv-z2-5MUP0BkWUwOazXV6PRnDIR3gk"><img width="2000" height="1076" alt="zeroclaw03" src="https://private-user-images.githubusercontent.com/7535786/555845353-79c605f0-ee39-42dc-a203-b40368dbbce7.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..CC8wD0oYwPZzTv-z2-5MUP0BkWUwOazXV6PRnDIR3gk" content-type-secured-asset="image/png" style="max-width: 100%; height: auto; max-height: 1076px;"></a>
...
[https://github.com/zeroclaw-labs/zeroclaw/releases/latest](https://github.com/zeroclaw-labs/zeroclaw/releases/latest)
